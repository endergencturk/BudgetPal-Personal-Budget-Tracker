...
- Her kullanıcıya özel veri ve bütçe hedefleri
...
- En çok harcanan kategori, gün ve günlük ortalama istatistikleri
...
### 📤 Export & Yedekleme
- 📄 **JSON** export / import (yedek ve geri yükleme)
- 📊 **CSV** export (Excel uyumlu)
- 📗 **Excel (.xlsx)** export
- 📕 **PDF Finansal Özet Raporu** — özet istatistikler, kategori dağılımı ve işlem listesi
